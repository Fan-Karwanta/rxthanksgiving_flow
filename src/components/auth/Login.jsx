  ...
  return (
    ...
    >
      <div className="container relative">
        <div className="relative z-1 max-w-[28rem] mx-auto">
          {/* Header */}
          <div className="text-center mb-10">
            ...
            <p className="body-1 text-n-3">
              Sign in to access your NexTap profile
            </p>
          </div>
          ...
          <div className="relative p-8 bg-n-8 rounded-2xl border border-n-6 backdrop-blur-sm animate-slide-up">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-n-7 border border-n-6 rounded-xl text-n-1 placeholder-n-4 focus:outline-none focus:border-color-1 focus:ring-1 focus:ring-color-1 transition-all duration-300"
                    placeholder="you@example.com"
                  />
                  <div className="absolute right-3 top-1/2 -translate-y-1/2 text-n-4">
              ...
              <div className="flex items-center justify-between">
                <label className="flex items-center gap-2 cursor-pointer">
                  <input
                    type="checkbox"
                    className="w-4 h-4 rounded border-n-6 bg-n-7 text-color-1 focus:ring-color-1 focus:ring-offset-0"
                  />
                  <span className="text-sm text-n-3">Remember me</span>
                </label>
                <Link
                  to="/forgot-password"
                  className="text-sm text-color-1 hover:text-color-1/80 transition-colors"
                >
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full py-3 px-6 bg-gradient-to-r from-color-1 to-color-5 text-white font-semibold rounded-xl hover:opacity-90 transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
              >
                {isLoading ? (
            ...
            <div className="relative my-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-n-8 text-n-4">Or continue with</span>
              </div>
            </div>
